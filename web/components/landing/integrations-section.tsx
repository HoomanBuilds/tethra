...
const integrations = [
  { name: "DeepBook Predict", category: "Protocol" },
  { name: "Sui", category: "Chain" },
  { name: "dUSDC", category: "Asset" },
  { name: "PLP Pool", category: "Liquidity" },
  { name: "SVI Oracle", category: "Feed" },
  { name: "Keeper Bot", category: "Off-chain" },
  { name: "Move Vault", category: "Contract" },
  { name: "BTC Markets", category: "Markets" },
  { name: "Exposure Caps", category: "Risk" },
  { name: "Auto-Compound", category: "Yield" },
  { name: "Settled Oracles", category: "Data" },
  { name: "dUSDC Deposit", category: "Deposit" },
];
    ...
    <section id="integrations" ref={sectionRef} className="relative overflow-hidden">
      ...
      <div className="relative z-10 pt-32 lg:pt-40 text-center">
        ...
        <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg mx-auto transition-all duration-1000 delay-100 ${
          ...
          The vault composes with DeepBook Predict, Sui, dUSDC, and the live oracle feed. One deposit, fully on-chain.
        </p>
      </div>
      ...
      <div className="relative z-10 mt-0 lg:-mt-24 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className={`flex flex-wrap items-center justify-between gap-8 pt-12 border-t border-foreground/10 transition-all duration-1000 delay-500 pb-32 lg:pb-40 ${
          ...
          <div className="flex flex-wrap gap-12">
            {[
              { value: "~1s", label: "Oracle feed" },
              { value: "PLP", label: "Liquidity supplied" },
              { value: "Permissionless", label: "Keeper redeem" },
            ].map((stat) => (

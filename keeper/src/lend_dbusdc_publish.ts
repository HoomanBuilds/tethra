...
async function main() {
  const modules = [
    ...
    loadModuleBytecode(`${LEND_BUILD}/lend_vault_dbusdc.mv`),
  ];
  ...
  // lend_vault_dbusdc adds: dbusdc (0xf7152c05...)
  const dependencies = [
    ...
    '0xf7152c05930480cd740d7311b5b8b45c6f488e3a53a11c3f74a6fac36a52e0d7', // dbusdc
  ];
